...
<%@ include file="includes/header.jsp" %>
	...
	<div class="hero">
		<div class="hero-slide">
			<div class="img overlay" style="background-image: url('/commu/resources/images/wallpaperbetter.jpg')"></div>
			<div class="img overlay" style="background-image: url('/commu/resources/images/wallpaperbetter (2).jpg')"></div>
			<div class="img overlay" style="background-image: url('/commu/resources/images/wallpaperbetter (3).jpg')"></div>
		</div>

		<div class="container">
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-9 text-center">
					<h1 class="heading" data-aos="fade-up">Commu Board에서 게시글을 검색하세요.</h1>
	...
	<div class="section">
		<div class="container">
			<div class="row mb-5 align-items-center">
				<div class="col-lg-6">
					<h2 class="font-weight-bold text-primary heading">인기 게시글</h2>
				</div>
				<div class="col-lg-6 text-lg-end">
					<p><a href="#" target="_blank" class="btn btn-primary text-white py-3 px-4">View all post</a></p>
				</div>
			</div>
			<div class="row">
